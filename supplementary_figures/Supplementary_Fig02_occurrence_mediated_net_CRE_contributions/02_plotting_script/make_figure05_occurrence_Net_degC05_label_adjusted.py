...
OUT_PNG = FIG_DIR / "Figure05_occurrence_mediated_Net_degC05_label_adjusted.png"
OUT_PDF = FIG_DIR / "Figure05_occurrence_mediated_Net_degC05_label_adjusted.pdf"
OUT_PLOT = RESULT_DIR / "Figure05_degC05_plot_data_label_adjusted.csv"
OUT_CAPTION = NOTES_DIR / "Figure05_degC05_caption_label_adjusted.md"
OUT_METHOD = NOTES_DIR / "Figure05_degC05_method_and_plot_checks_label_adjusted.txt"
...
def add_group_labels_panel_a(ax: plt.Axes) -> None:
    ax.text(5.6, 0.9, "High cloud", fontsize=12, color="black", ha="left", va="center", fontweight="bold", zorder=6)
    ax.text(5.6, 5.5, "Low cloud", fontsize=12, color="black", ha="left", va="center", fontweight="bold", zorder=6)
    ax.text(5.6, 3.5, "Mid-level\n  cloud", fontsize=12, color="black", ha="left", va="center", fontweight="bold", zorder=6)
